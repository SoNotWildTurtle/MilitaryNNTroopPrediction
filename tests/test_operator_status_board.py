    ...
    def test_build_status_board_summarizes_ready_bundle(self) -> None:
        with TemporaryDirectory() as temp_dir:
            ...
            files = [
                ...
                {"path": "release-health.md", "size_bytes": 12, "sha256": "c" * 64},
                {"path": "triage-summary.md", "size_bytes": 13, "sha256": "d" * 64},
                {"path": "artifact-manifest.md", "size_bytes": 14, "sha256": "e" * 64},
                {"path": "dashboard-mockup.html", "size_bytes": 15, "sha256": "f" * 64},
            ]
