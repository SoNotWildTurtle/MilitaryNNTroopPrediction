...
class HandoffGapReportReviewTests(unittest.TestCase):
    ...
    def test_clear_gap_report_marks_targets_ready_for_review(self) -> None:
        ...
        self.assertEqual(review["reviewer_action_summary"]["action_count"], 1)
        self.assertEqual(review["reviewer_action_summary"]["review_action_count"], 1)
        self.assertEqual(review["reviewer_action_summary"]["blocking_action_count"], 0)
        self.assertFalse(review["reviewer_action_summary"]["has_blocking_actions"])
        self.assertEqual(review["reviewer_action_summary"]["unknown_priorities"], [])
        ...
        self.assertIn("Reviewer action summary", markdown)
        self.assertIn("Review action count: 1", markdown)
    ...
    def test_gap_report_missing_and_suspicious_targets_block_review(self) -> None:
        ...
        self.assertEqual(review["reviewer_action_summary"]["action_count"], 2)
        self.assertEqual(review["reviewer_action_summary"]["blocking_action_count"], 2)
        self.assertEqual(review["reviewer_action_summary"]["review_action_count"], 0)
        self.assertTrue(review["reviewer_action_summary"]["has_blocking_actions"])
        self.assertIn("Regenerate the missing release bundle artifact", review["reviewer_action_summary"]["first_blocking_action"])
        ...
        self.assertIn("Blocking action count: 2", markdown)
    ...
    def test_writers_create_markdown_and_json_outputs(self) -> None:
        ...
        self.assertEqual(parsed["reviewer_action_summary"]["priority_counts"]["review"], 1)
