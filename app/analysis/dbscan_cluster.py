...
def cluster_recent_movements(
    ...
    """
    positions = recent_positions(unit_id, hours, start=start, end=end)
    if not positions:
...
if __name__ == "__main__":
    ...
    cluster_recent_movements(args.unit_id, args.hours, args.eps, args.min_samples, start=start, end=end)
