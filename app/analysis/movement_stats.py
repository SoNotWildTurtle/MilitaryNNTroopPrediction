...
def compute_stats_from_points(points: List[Dict]) -> Dict[str, float]:
    """Compute movement statistics from an in-memory list of points."""
    points = sorted(
        points,
...
def movement_stats(
    ...
    points: List[Dict] = recent_positions(unit_id, hours, start=start, end=end)
