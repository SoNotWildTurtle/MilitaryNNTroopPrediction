...
_EXPECTED_ARTIFACT_ROWS = [
    ...
    ("uncertainty-review-packet.md", "Human-readable uncertainty review packet for analytical handoff."),
    ("uncertainty-review-packet.json", "Machine-readable uncertainty review packet for analytical handoff."),
    ("handoff-integrity-report.md", "Human-readable cross-artifact handoff integrity report."),
    ("handoff-integrity-report.json", "Machine-readable cross-artifact handoff integrity report."),
    ...
    ("implementation-acceptance-checklist.md", "Human-readable implementation acceptance gates for selected additive increments."),
    ("implementation-acceptance-checklist.json", "Machine-readable implementation acceptance gate evidence manifest."),
    ("implementation-acceptance-handoff.md", "Human-readable completed-evidence handoff readiness summary for reviewers."),
    ("implementation-acceptance-handoff.json", "Machine-readable completed-evidence handoff readiness summary for reviewers."),
    ...
    ("uncertainty-review-packet-help.txt", "Current uncertainty review packet CLI options."),
    ("handoff-integrity-report-help.txt", "Current handoff integrity report CLI options."),
    ...
    ("implementation-acceptance-checklist-help.txt", "Current implementation acceptance checklist CLI options."),
    ("implementation-acceptance-handoff-help.txt", "Current implementation acceptance handoff CLI options."),
