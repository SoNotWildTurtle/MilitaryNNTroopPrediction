...
EXPECTED_ARTIFACTS: Dict[str, str] = {
    ...
    "artifact-gap-report.json": "Machine-readable completeness audit for generated diagnostic artifacts.",
    "artifact-gap-report.md": "Human-readable completeness audit for generated diagnostic artifacts.",
