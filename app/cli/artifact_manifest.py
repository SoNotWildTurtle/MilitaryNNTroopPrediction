...
EXPECTED_ARTIFACTS: Dict[str, str] = {
    ...
    "operator-next-steps.md": "Human-readable ranked operator action plan generated from diagnostics.",
    "operator-next-steps.json": "Machine-readable ranked operator action plan generated from diagnostics.",
