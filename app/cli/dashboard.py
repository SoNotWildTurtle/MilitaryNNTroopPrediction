...
from ..cli.operational_analysis_report import run_operational_analysis_report
from ..cli.military_campaign_report import run_military_campaign_report
from ..cli.theater_assessment_report import run_theater_assessment_report
...
def _analysis_menu() -> str:
    ...
    table.add_row("23", _t("Operational tactics overview"))
    table.add_row("24", _t("Military campaign assessment"))
    table.add_row("25", _t("Theatre outlook"))
    table.add_row("0", _t("Back"))
