...
def build_operator_digest(artifact_dir: Path = DEFAULT_ARTIFACT_DIR, generated_at: datetime | None = None) -> Dict[str, Any]:
    ...
    digest: Dict[str, Any] = {
        ...
        "safe_scope": "Local setup, deterministic tests, synthetic examples, API contracts, generated artifacts, documentation, and defensive analytical software behavior.",
    }
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--artifact-dir", type=Path, default=DEFAULT_ARTIFACT_DIR, help=f"artifact directory; default: {DEFAULT_ARTIFACT_DIR}")
    parser.add_argument("--markdown-path", type=Path, default=None, help="Markdown output path; default: <artifact-dir>/operator-digest.md")
    parser.add_argument("--json-path", type=Path, default=None, help="JSON output path; default: <artifact-dir>/operator-digest.json")
