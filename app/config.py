...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.EMAIL_SMTP_HOST: str = os.getenv("EMAIL_SMTP_HOST", "")
        self.EMAIL_SMTP_PORT: int = int(os.getenv("EMAIL_SMTP_PORT", "587"))
        self.EMAIL_SMTP_USERNAME: str = os.getenv("EMAIL_SMTP_USERNAME", "")
        self.EMAIL_SMTP_PASSWORD: str = os.getenv("EMAIL_SMTP_PASSWORD", "")
        self.EMAIL_FROM_ADDRESS: str = os.getenv("EMAIL_FROM_ADDRESS", "")
        email_tls_raw = os.getenv("EMAIL_USE_TLS", "1").lower()
        self.EMAIL_USE_TLS: bool = email_tls_raw in {"1", "true", "yes", "on"}
