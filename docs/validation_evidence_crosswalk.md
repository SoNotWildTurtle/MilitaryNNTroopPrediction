...
Roll back this guidance by reverting this document, its README/changelog references, and its static regression test. That rollback is documentation-only and should not remove existing CLI commands, generated artifact contracts, or prior validation runbooks.
