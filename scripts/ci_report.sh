...
# Release notes, triage summaries, reviewer handoffs, and operator session plans
...
# context, ranked next-session guidance, and the final machine-readable manifest
