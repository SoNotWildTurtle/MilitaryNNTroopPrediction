...
- `docs/validation_evidence_crosswalk.md` – reviewer question-to-evidence map for commands, hosted checks, artifacts, blockers, compatibility notes, and rollback fields
