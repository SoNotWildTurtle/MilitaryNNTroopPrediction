...
- `cli/fusion_report.py` – run camera, LIDAR, and Bluetooth detection for troops, vehicles, and drones and display fused results; accepts `--image`, `--pointcloud`, and `--bluetooth` to skip prompts.
