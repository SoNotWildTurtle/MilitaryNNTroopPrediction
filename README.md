...
The exporter writes JSONL, CSV, and Markdown files under `data/fixtures/` by
default. Use `--output-dir` for isolated CI or review artifacts.
...
synthetic fixture export, bundle index, artifact manifest, and HTML preview tools.
