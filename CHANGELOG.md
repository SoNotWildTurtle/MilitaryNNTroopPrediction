...
- Added `docs/validation_evidence_crosswalk.md`, README navigation, and static regression coverage so reviewer questions map directly to local commands, hosted check evidence, generated artifacts, merge blockers, compatibility notes, rollback fields, and safe analytical framing without replacing existing validation runbooks.
