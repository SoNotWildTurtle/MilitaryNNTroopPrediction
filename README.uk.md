...
Після налаштування оберіть у панелі пункт «Деталізація об’єктів та сповіщення», створіть drilldown-звіт зі середніми швидкостями для бронетехніки, авіації та дронів і надішліть підсумок на вибрані номери через Twilio.
