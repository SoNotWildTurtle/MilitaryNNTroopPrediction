...
- `cli/doctrine_movement_report.py` – докладний аналіз руху за доктринами в розрізі підрозділів, груп або батальйонів.
...
python -m app.cli.doctrine_movement_report  # доктринальний аналіз руху
